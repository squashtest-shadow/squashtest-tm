...
class HibernateTestCaseDeletionDaoIT extends DbunitDaoSpecification{
	...
	@DataSet(value=["NodeDeletionDaoTest.should cascade delete on attachments.xml"])
	...
	@DataSet(value=["NodeDeletionDaoTest.removal of test steps should disassociate them from their parents.xml"], loadStrategy=CleanInsertLoadStrategy.class)
