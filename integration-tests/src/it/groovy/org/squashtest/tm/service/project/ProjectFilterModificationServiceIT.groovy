...
class ProjectFilterModificationServiceIT extends DbunitServiceSpecification {
	...
	{
		def activated = true
		Long projectId1 = Long.valueOf(1)
		Long projectId2 = Long.valueOf(2)
		Long projectId3 = Long.valueOf(3)
		//list with project 1
		List<Long> projectIdList1 = new ArrayList<Long>()
		projectIdList1.add(projectId1)
		//list with project 1&2
		List<Long> projectIdList12 = new ArrayList<Long>()
		projectIdList12.add(projectId1)
		projectIdList12.add(projectId2)
		//list with project 1,2&3
		List<Long> projectIdList123 = new ArrayList<Long>()
		projectIdList123.add(projectId1)
		projectIdList123.add(projectId2)
		projectIdList123.add(projectId3)
		...
		List<Project> projectList12 = new ArrayList<Project>()
		...
		List<Project> projectList123 = new ArrayList<Project>()
