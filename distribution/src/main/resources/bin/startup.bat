...
@REM     Copyright (C) 2010 - 2011 Squashtest TM, Squashtest.org
@REM
...
java -Dfelix.config.properties=file:../conf/felix.config.properties -Dfelix.system.properties=file:../conf/felix.system.properties -jar ${felix.artifactId}-${felix.version}.jar