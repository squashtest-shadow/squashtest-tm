...
java -Dfelix.config.properties=file:../conf/felix.config.properties -Dfelix.system.properties=file:../conf/felix.system.properties -jar org.apache.felix.main-3.2.1.jar -Xms256m -Xmx512m 
