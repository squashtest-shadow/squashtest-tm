...
public class StdReportConfig {
	...
	@Bean
	public MessageSource stdReportMessageSource() {
		ReloadableResourceBundleMessageSource bean = new ReloadableResourceBundleMessageSource();
		bean.setCacheSeconds(60);
		bean.setBasenames(
			"classpath:org/squashtest/tm/plugin/report/std/messages",
			squashPathProperties.getLanguagesPath() + "/plugin.report.std/messages"
		);
		return bean;
	}
}
