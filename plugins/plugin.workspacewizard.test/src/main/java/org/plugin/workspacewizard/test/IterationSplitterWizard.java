...
public class IterationSplitterWizard implements WorkspaceWizard{

	@Override
	public String getName() {
		return "iteration splitter";
	}

	@Override
	public String getId() {
		return "squashtm.test.splitter.iteration";
	}
	...
	public MenuItem getWizardMenu() {
		return new DefaultMenuItem("iteration splitter", "splits your iterations into test suites", "api/splitter/iteration");
	}
