...
public class TestCaseLibraryWizard extends MultiWorkspaceWizard{
	...
	public MenuItem getWizardMenu() {
		return new DefaultMenuItem("multiwizard", "allows you to do stuffs across workspaces", "api/multi/test-case");
	}
