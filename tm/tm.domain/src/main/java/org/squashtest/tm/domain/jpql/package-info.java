 ...
 * 
 * <p>
 * 	Just invoke SessionFactoryEnhancer#registerAggregateWrappers() when configuring your session factory and you're ready for use in HQL queries.
 * 	Criteria queries doesn't support the new functions though. See SessionFactoryEnhancer documentation for more details.
 * </p>
 * 
 * <h4>QueryDSL</h4>
 * 
