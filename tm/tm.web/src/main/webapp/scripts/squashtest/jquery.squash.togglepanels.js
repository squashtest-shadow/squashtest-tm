			...
			.widget(
					"ui.togglePanel",
					{
						...
						_create : function() {
							...
							// the buttons now
							var inputs = $('.toggle-panel-buttons input',
									wrapper);
							inputs.squashButton();
						...
						_init : function() {
							...
							if (settings.initiallyOpen) {
								...
								this.element.hide();
								panelHead
										.toggleClass('ui-state-focus ui-state-active ui-corner-top ui-corner-all');
							}
						...
						toggleContent : function() {
							...
							if (this.element.parent().hasClass(
									'ui-effects-wrapper')) {
								return;
							}
							...
							panelHead
									.toggleClass("ui-state-focus ui-state-active ui-corner-top ui-corner-all tg-open");

							// now disable or enable the buttons.
							var disabled = (panelHead.hasClass('tg-open')) ? false
									: true;
							panelHead.find(':button, .button').squashButton(
