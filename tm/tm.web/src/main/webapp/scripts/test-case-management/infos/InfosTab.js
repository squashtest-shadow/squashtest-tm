...
define([ "jquery", "backbone", "underscore", 
		...
		Backbone, _, GeneralInfosPanel, PrerequisitePanel, TestAutomationPicker, TestAutomationRemover, TestCaseVerifiedRequirementsPanel, bugtracker, eventBus, translator) {
