...
define(
		[
				...
				"jqueryui" ],
		function($, Backbone, Handlebars, BTEntity, source) {
			...
			var ComboBox = DefaultFieldControl
					.extend({
						...
						updatecontrol : function() {
							if (!this.empty) {
								DefaultFieldControl.prototype.updatecontrol
			...
			var DefaultFieldView = Backbone.View.extend({
				...
				// we must prevent keypress=enter event inside a textarea to
				// bubble out and reach
				// the submit button
