		...
		function($) {
			...
			function bindSelectChange(settings) {
				...
				$("#user-permissions-table").on(
						...
						function() {
							...
							var data = $("#user-permissions-table")
									.squashTable().fnGetData(tr);
							...
							var url = squashtm.app.contextRoot
									+ "/generic-projects/" + projectId
									+ "/parties/" + partyId + "/permissions/"
									+ $this.val() + "/";
			...
			function initUserPermissions(settings) {
				...
				var datatableSettings = {
					...
					"bProcessing" : true,
					"bServerSide" : true,
					"sAjaxSource" : squashtm.app.contextRoot
							+ "/generic-projects/" + settings.basic.projectId
							+ "/party-permissions",
				...
				var squashSettings = {
					...
					deleteButtons : {
						...
						url : squashtm.app.contextRoot + "/generic-projects/"
								+ settings.basic.projectId
					...
					bindLinks : {
						list : [ {
							url : squashtm.app.contextRoot
									+ "/administration/parties/{party-id}/info",
