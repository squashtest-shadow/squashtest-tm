...
define(["jquery", "backbone", "underscore", "squash.basicwidgets", "jeditable.simpleJEditable",
		"workspace.routing", "squash.translator",
		...
		function($, backbone, _, basic,	SimpleJEditable, routing, translator, Forms, StringUtil) {
	"use strict";
	...
	var TableView = Backbone.View.extend({
		...
		tableInit : function() {
			...
			this.optionsTable = this.$("#requirement-link-types-table");
			var self = this;
