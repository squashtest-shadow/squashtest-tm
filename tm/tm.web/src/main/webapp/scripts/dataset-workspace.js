...
require(["common"], function () {
	...
	require(["jquery", './dataset-workspace/dataset-workspace-main', "app/ws/squashtm.workspace", 'backbone.wreqr',
		...
		function ($, datasetWorkspace, WS, wreqr, Backbone, router) {
			$(function () {
				...
				datasetWorkspace.init(window.squashtm.app.datasetWorkspaceConf);
			});
		});
});
