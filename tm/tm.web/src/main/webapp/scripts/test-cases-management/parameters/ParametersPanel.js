		...
		function($, Backbone, ParametersTable, NewParameterDialog) {
			...
			var ParametersPanel = Backbone.View.extend({
				...
				configureButtons : function() {
					...
					// =============/toogle buttons===================
					this.$("#add-parameter-button").on('click',
							self.showNewParameterDialog
//							function() {
//								new AddParameterPopup({settings : self.settings, model : {name:"", description:""}});
//							});
				},
				...
				showNewParameterDialog : function(event) {
					...
					function discard() {
						self.newParameterDialog.off("newteam.cancel newteam.confirm");
