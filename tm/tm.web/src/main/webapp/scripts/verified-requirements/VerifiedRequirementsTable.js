		...
		function($, Backbone, _, StringUtil) {
			...
			var VerifiedRequirementsTable = Backbone.View.extend({
				...
				configureRemoveRequirementDialogs : function() {
					...
					this.confirmRemoveRequirementDialog = $("#remove-verified-requirement-version-dialog")
							.confirmDialog();
					...
					this.confirmRemoveObsoleteRequirementDialog.on("confirmdialogconfirm", $
					.proxy(this.removeRequirements, this));
				...
				_refresh :function () {
					var self = this;
					saveTableSelection(self.table, function(data){return data["entity-id"];});
