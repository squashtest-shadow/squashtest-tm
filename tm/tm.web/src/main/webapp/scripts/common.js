...
requirejs.config({
	 ...
	 * any unrequired "ext" suffix.
	 */
	paths : {
		"domReady" : "lib/require/domReady",
		/*
		 * CAVEAT: as we defined a "jquery" path, any module named
		 * "jquery/my.module" will be interpolated as "/lib/jquery/../my.module"
		 */
	...
	shim : {
		...
		"jquery.squash.jstree" : {
			deps : [ "jquery", "jstree", "jquery.squash.jstree-node", "jquery.squash", "jquery.squash.squashbutton" ],
