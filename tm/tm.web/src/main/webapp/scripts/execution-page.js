...
define(['module', 'jquery', 'app/pubsub', 'squash.basicwidgets', 'app/ws/squashtm.workspace', 'squash.translator', 'app/ws/squashtm.notification', 'workspace.routing', 
	...
	function initToolbar(){
		...
		cufValuesManager.infoSupport.init("#execution-information-table", config.basic.cufs.denoCufs, displayMode);
		cufValuesManager.infoSupport.init("#execution-information-table", config.basic.cufs.normal, displayMode);
