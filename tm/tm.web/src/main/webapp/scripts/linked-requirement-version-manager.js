...
require([ "common" ], function() {
    ...
    "squash.translator", "app/ws/squashtm.notification", "req-workspace/linked-requirements-panel", "jqueryui", "jquery.squash.messagedialog", "squashtable", "app/ws/squashtm.workspace" ],
		...
		$(document).on("click", "#add-items-button", function(event){
			squash.vent.trigger("linked-requirement-versions:bind-selected", { source: event });
		});
