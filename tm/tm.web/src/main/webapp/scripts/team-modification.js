...
require([ "common" ], function(common) {
	require([ "jquery", "http://localhost/scripts/scripts/team-editor/TeamModificationView.js","app/ws/squashtm.workspace", "domReady" ], function($,TeamModificationView, WS, domReady) {
		var goBack = function() {
