 ...
 */
define(
		[ "jquery", "backbone", "./TestStepInfoModel",
				"../verified-requirements/TestStepVerifiedRequirementsPanel",
				"app/lnf/Forms", "jquery.squash", "jqueryui",
		...
		function($, Backbone, TestStepInfoModel, VerifiedRequirementsPanel,
			 ...
			 */
			var TestStepModificationView = Backbone.View
					.extend({
						...
						fillModelAttributes : function(modelAttributes) {
							...
							$.each(fields, function(index, value) {
								modelAttributes[$(value).attr("name")] = $(
										value).val();
							});
							...
							if (cufValuesValues.length > 0) {
								...
								$.each(cufValuesValues, function(index, value) {
									modelAttributes.cufValues[$(value).attr(
											"name")] = self
											.getInputValue(value);
								});
							}
						...
						configureCKEs : function() {
							...
							textareas.each(function() {
								...
								CKEDITOR.instances[$(this).attr("id")].on(
										'change', function(e) {
											self.updateCKEModelAttr.call(self,
													e);
										});
							});
						},
						...
						updateCKEModelAttr : function(event) {
							...
							var attrName = attrInput.element.$
									.getAttribute("name");
