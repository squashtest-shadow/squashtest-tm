...
define([ "jquery", "./NewCustomFieldOptionDialog", "backbone", "underscore",
	...
	"jquery.squash.messagedialog", "jquery.squash.confirmdialog", "jeditable.datepicker",
	"datepicker/jquery.squash.datepicker-locales", "squashtest/jquery.squash.popuperror" ],
function($, NewCustomFieldOptionDialog, Backbone, _, SimpleJEditable,SelectJEditable, StringUtil, oneshot) {
	...
	var CustomFieldModificationView = Backbone.View.extend({
		...
		initialize : function() {
			...
			this.optionalCheckbox = this.$("#cf-optional").get(
					0);
