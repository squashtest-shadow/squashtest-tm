...
<f:message var="datasetTitle" 	key="workspace.dataset.button.label"/>
...
<div id="navigation" data-highlight="${ highlighted }">
	<div id="test_mgt_nav">
		...
		<a id="dataset-link"	 	style="margin-top: 10px;"	class="navigation-link navigation-campaign"		href="${rootctxt}/dataset-workspace/"		title="${datasetTitle}"></a>
	</div>
