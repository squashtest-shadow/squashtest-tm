...
<script type="text/javascript">
	function selectLibrary(node) {
		...
		var selNodeUrl = nodeResourceUrl('${ resourceUrlRoot }',  node);
		var selNodeContentUrl = nodeContentUrl('${ libraryUrl }', node);
		var selNodeId = node.attr('id');
	
		setTreeData(selNodeUrl, selNodeContentUrl, selNodeId);
		loadContextualContentIfRequired(node, selNodeUrl);
	}
