...
<%@ attribute name="initialDate" required="true" description="the date to set the datepicker to when loading the page" %>
<%@ attribute name="isAuto" required="true" description="tells whether the user manually set the date or note. true or false."%>
<%@ attribute name="autosetParamName" required="true" description="name of the flag being posted to the server, telling if the user is setting this date manually or not" %>
...
<script type="text/javascript">
	...
	$(function(){
		...
		myDatePicker = new DatePickerAuto(controls, params);
	});
