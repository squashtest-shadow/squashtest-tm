...
<layout:info-page-layout titleKey="squashtm.library.campaign.title" highlightedWorkspace="campaign">
	...
	<jsp:attribute name="informationContent">	
		<jsp:include page="/WEB-INF/jsp/fragment/issues/bugtracker-panel.jsp">
