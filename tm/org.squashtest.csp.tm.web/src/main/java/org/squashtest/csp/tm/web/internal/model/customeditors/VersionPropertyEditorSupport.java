...
public class VersionPropertyEditorSupport extends BugTrackerPropertyEditorSupport<Version> {
	...
	public void setValue(Object value) {
		if (value instanceof String) {
			...
			Version entity;
			if (id.equals(Version.NO_VERSION.getId())){
				entity=Version.NO_VERSION;
			}
			else{
				entity = new Version(id, name);
			}
			...
			super.setValue(Version.NO_VERSION);
		}
	...
	public String getAsText() {
		Version entity =(Version) getValue();
	...
	public void setAsText(String text){		
		...
		Version entity = new Version(id, name);
		super.setValue(entity);		
	}
