...
class ExcelTestCaseParserImplTest extends Specification {
	...
	def "should parse the description tag"(){
		...
		then :
			ptc.descriptionElements.collect{[it[0], it[1]]} == [["Description", "this is sparta"]]
	...
	def "should parse the action tag"(){
		...
		then :
			ptc.stepElements.collect{[it[0], it[1]]} == [["action !", "a-a-a-a-action !"]]
	...
	def "should parse a description and additional description and order them properly"(){
		...
		then :
			ptc.descriptionElements.collect{[ it[0], it[1] ]} == [ ["Description", "the proper description"],
	...
	def "at a list of steps"(){
		...
		then :
			...
			formated.collect{ [it.action, it.expectedResult]} == [ ["<p>action 1</p>", "<p>result 1</p>"],
					["<p>action 2</p>", "<p>result 2</p>"],
					["<p>action 3</p>", "<p>result 3</p>"],
					["<p>action 4</p>", "<p>result 4</p>"]
					]
	...
	def "at a single description"(){
		...
		given :
			def ptc = new PseudoTestCase();
			ptc.descriptionElements.add(["description", "that's a fine description"] as String[])	
	...
	def "at a description with additional elements"(){
		...
		given :
			def ptc = new PseudoTestCase();
			ptc.descriptionElements.add(["description", "that's a fine description"] as String[])
			ptc.descriptionElements.add(["additional 1", "that additional sentence is relevant"] as String[])
			ptc.descriptionElements.add(["additional 2", "that one too"] as String[])
