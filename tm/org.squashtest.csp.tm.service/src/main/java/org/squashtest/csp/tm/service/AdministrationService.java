 ...
 * For all operations about user authentication, the said operation will be delegated to the UserAuthenticationManagerService.
 * 
 * Security should ensure that : 
 * 	
 * 	- access to user informations (both reading and writing) are opened to the said user ROLE_ADMIN authority only,
 *  - the rest requires ROLE_ADMIN authority only.
 *  
 * @author bsiri
 *
 */
