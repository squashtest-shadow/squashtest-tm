...
import org.squashtest.csp.tm.domain.report.common.dto.ExProgressCampaignDto;
import org.squashtest.csp.tm.domain.report.common.dto.ExProgressIterationDto;
import org.squashtest.csp.tm.domain.report.common.dto.ExProgressProjectDto;
import org.squashtest.csp.tm.domain.report.common.dto.ExProgressTestPlanDto;
...
public class HibernateExecutionProgressQuery extends HibernateReportQuery {
	 ...
	 *
	 * (non-Javadoc)
	 * @see org.squashtest.csp.tm.domain.report.query.hibernate.HibernateReportQuery#createHibernateQuery()
	 */
	@Override
