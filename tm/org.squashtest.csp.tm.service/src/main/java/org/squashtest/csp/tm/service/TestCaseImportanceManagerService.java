...
public interface TestCaseImportanceManagerService {
	 ...
	 * @param testCases list of test-cases added to the requirement
	 * @param requirement
	 */
	void changeImportanceIfRelationsAddedToReq(List<TestCase> testCases, Requirement requirement);
	/**
	 * will compute ant update the importance of the test-case if it's importance is auto <br>
	 * and, if necessary, will update the importance of any test-case calling the parameter test-case.
	 * 
	 * @param requirements list of requirements added to the test-case
	 * @param testCase
	 */
	 ...
	 */
	void changeImportanceIfRequirementCriticalityChanged(long requirementId, RequirementCriticality oldRequirementCriticality);
