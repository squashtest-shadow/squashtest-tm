 ...
 */
package org.squashtest.csp.tm.domain.report.query.hibernate;
 ...
 *  far, including a post processing method {@see HibernateReportQuery#convertToDto(java.util.List)}. The corresponding ReportQueryDao,
 *  namely {@see HibernateReportQueryDao} is aware of that method and will invoke it.
 *  
 *  That method is useful for any post processing like the use of a DataFilteringService {@see DataFilteringService}, {@see ReportQuery}
...
public abstract class HibernateReportQuery implements ReportQuery {
	 ...
	 * @return the map of ReportCriterion, identified by their names (the name does exists both in the Map and in the ReportCriterion).
	 */
	 ...
	 *
	 * @param criteria the DetachedCriteria query to which we add a Criterion.
	 * @param criterionName the name of the corresponding ReportCriterion.
	 * @return
	 */
	 ...
	 *
	 * @param rawData a List of Hibernate entities.
