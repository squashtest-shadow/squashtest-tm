...
public interface RequirementModificationService {
	...
	void updateDescription(long reqId, String newDescription);
	...
	void updateRequirementCriticality(long requirementId, RequirementCriticality criticality);
	
	void updateRequirementReference(long requirementId, String reference);
