...
public interface PrivateCustomFieldValueService extends CustomFieldValueManagerService {
	...
	/**
	 * Will create the custom field values for an entity. Will not recreate custom field values if they exist already.
	 * 
	 * @param entity
	 */
	void createCustomFieldValues(BoundEntity entity);
