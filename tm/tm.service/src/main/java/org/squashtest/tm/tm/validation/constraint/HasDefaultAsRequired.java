...
import org.squashtest.tm.internal.validation.validator.CustomFieldHasDefaultAsRequiredValidator;
...
public @interface HasDefaultAsRequired {
	String message() default "{org.squashtest.tm.tm.validation.constraint.HasDefaultAsRequired}";
