...
public class FilteredCollectionHolder<COLLECTION extends Collection<?>> {
	...
	public FilteredCollectionHolder(long unfilteredResultCount, COLLECTION filteredCollection) {
		super();
		this.unfilteredResultCount = unfilteredResultCount;
		this.filteredCollection = filteredCollection;
	}

	public long getUnfilteredResultCount() {
		return unfilteredResultCount;
	}
