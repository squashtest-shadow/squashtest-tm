...
import org.squashtest.tm.domain.dto.CustomFieldModel;
import org.squashtest.tm.domain.dto.InputTypeModel;
...
import static org.squashtest.tm.bugtracker.advanceddomain.InputType.DATE_PICKER;
import static org.squashtest.tm.domain.customfield.InputType.DROPDOWN_LIST;


@Component
class SqlCustomFieldModelFactory {
...
//		model.setFriendlyName(getMessage(type.getI18nKey()));
	...
	CustomFieldModel<?> createCustomFieldModel(ResultSet rs) throws SQLException {
...
//		}
	...
	private void initModel(ResultSet rs, CustomFieldModel<String> model) throws SQLException {
...
//		model.setFriendlyOptional(field.isOptional() ? getMessage("label.Yes") : getMessage("label.No"));
	...
	public static class CustomFieldOptionModel {
		...
		public boolean equals(Object o) {
			...
			CustomFieldOptionModel that = (CustomFieldOptionModel) o;
