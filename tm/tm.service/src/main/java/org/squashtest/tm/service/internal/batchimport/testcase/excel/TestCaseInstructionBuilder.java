...
class TestCaseInstructionBuilder {
	...
	private PropertyHolderFinderRepository<TestCaseSheetColumn> propHolderFinderRepository = PropertyHolderFinderRepository.forWorksheet(TemplateWorksheet.TEST_CASES_SHEET);
