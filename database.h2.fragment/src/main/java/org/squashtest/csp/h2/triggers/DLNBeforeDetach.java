...
/**
 * Triggered before a DatasetLibraryNode is detached from its parent. It will cut from the
 ...
 *
 */
public class DLNBeforeDetach extends TriggerAdapter {

	private static final String SQL =
		"delete from DLN_RELATIONSHIP_CLOSURE "+
		"where descendant_id in ("+
			"select descendant_id from DLN_RELATIONSHIP_CLOSURE where ancestor_id=?"+
		") "+
