 ...
 * 
 */
class NamedQueryEntityFinderHandler<ENTITY> extends AbstractNamedQueryFinderHandler<ENTITY> {
	 ...
	 */
	public NamedQueryEntityFinderHandler(Class<ENTITY> entityType, @NotNull SessionFactory sessionFactory) {
